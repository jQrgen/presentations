...
const ORDER = ["title", "critique", "perTx", "chart", "absolute", "ntnu", "ewaste", "fair", "scale", "payments", "tokens", "batons", "capd", "secrets", "contracts", "identity", "norway", "table", "closing"];

const META = {
  en: { pageTitle: "Nexa vs Bitcoin and Ethereum", meta: "19 slides · Jørgen S. Notland · Norway 2026" },
  no: { pageTitle: "Nexa mot Bitcoin og Ethereum", meta: "19 slides · Jørgen S. Notland · Norge 2026" },
}[LANG];
